...
const WhyChooseUs = () => {
  ...
  return (
    <section id="why-us" className="min-h-screen flex items-center py-12 sm:py-16 lg:py-20 bg-secondary text-secondary-foreground" aria-label="Mengapa memilih CV Prima Putra Perkasa">
